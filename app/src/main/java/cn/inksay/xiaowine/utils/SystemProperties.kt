...
object SystemProperties {
    @SuppressLint("PrivateApi") operator fun get(context: Context, key: String?): String {
        var ret: String
        try {
            val cl = context.classLoader
            val systemProperties = cl.loadClass("android.os.com.example.template.utils.SystemProperties")
            //参数类型
